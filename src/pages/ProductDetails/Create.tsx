...
const Create = () => {
  ...
  return (
    <>
      ...
      <form className="grid grid-cols-1 gap-9 sm:grid-cols-2" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              ...
              <div>
                ...
                <div className="mb-6">
                  ...
                  ></label>
                  <ReactQuill value={description} onChange={handleContentChange}
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="grid grid-cols-2 gap-4 p-6">
              ...
              <div>
                ...
                >
                  <option value="
                  category">Choose Category</option>
                  {categories.map((cat) => (
              ...
              <div className="flex flex-col gap-5.5 p-6.5">
                ...
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    id="chargeTax"
                    className="form-checkbox h-4 w-4 ml-1 text-primary rounded border-gray-300 focus:ring-primary dark:border-form-strokedark"
                  />
                  <label
                    htmlFor="chargeTax"
